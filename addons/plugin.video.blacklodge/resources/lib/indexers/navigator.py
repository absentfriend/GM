...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem(32011, 'movieTmdbGenres', 'genres.png', 'DefaultMovies.png')
        self.addDirectoryItem(32012, 'movieYears&code=en', 'years.png', 'DefaultMovies.png')
        self.addDirectoryItem(32123, 'movieDecades', 'years.png', 'DefaultMovies.png')
        self.addDirectoryItem(32014, 'movieLanguages&code=en', 'languages.png', 'DefaultMovies.png')
        self.addDirectoryItem(32015, 'movieCertificates&code=en', 'certificates.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem(32011, 'tvTmdbGenres', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32016, 'tvNetworks', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32014, 'tvLanguages&code=en', 'languages.png', 'DefaultTVShows.png')
