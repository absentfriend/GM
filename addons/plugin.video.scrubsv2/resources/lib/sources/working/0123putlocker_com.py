...
class source:
    def __init__(self):
        self.results = []
        self.domains = ['0123putlocker.com', '123putlocker.io']
        self.base_link = 'https://0123putlocker.com'
        self.search_link = '/search-movies/%s.html'
        self.notes = 'Site sometimes loads too slow, and timeout is reached before reaching the html.'
