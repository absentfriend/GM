...
class source:
    def __init__(self):
        self.results = [] # Spare Dupe Sites: attacker.tv  hdtoday.cc  moviekids.tv  solarmovie.pe  yesmovies.mn  zoechip.com
        self.domains = ['attacker.tv', 'himovies.top']
        self.base_link = 'https://attacker.tv'
