...
class source:
    def __init__(self):
        self.results = []
        self.domains = ['gomoviz1.ink', 'gomoviz1.icu', '0gomoviz.me', 'gomoviz1.click', 'gomoviz.store', 'gomoviz.gay',
            '0gomoviz.net', '0gomoviz.com', 'gomoviz.top', 'gomoviz.uno', 'gomoviz.cyou', 'gomoviz.online', 'gomoviz.us',
            'gomoviz.xyz', 'gomoviz.org', 'gomoviz.live'
        ]
        self.base_link = 'https://gomoviz1.ink'
