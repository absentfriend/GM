...
class source:
    def __init__(self):
        self.results = []
        self.domains = ['yomovies.team', 'yomovies.work', 'yomovies.hair', 'yomovies.bid', 'yomovies.bio',
            'yomovies.rest', 'yomovies.kim', 'yomovies.run', 'yomovies.fyi', 'yomovies.rs', 'yomovies.cloud',
            'yomovies.skin', 'yomovies.vip', 'yomovies.ws', 'yomovies.bz', 'yomovies.lol'
        ]
        self.base_link = 'https://yomovies.team'
