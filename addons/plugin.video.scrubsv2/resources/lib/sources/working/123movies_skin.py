...
class source:
    def __init__(self):
        self.results = [] # dupe site that can likely be used which has the same shit. soap2day.quest (found thru 123-movies.pics html)
        self.domains = ['123-movies.mom', '123-movies.pics', '123-movies.life', '123-movies.skin',
            '123-movies.pro', '123movies4u.top', '123movies4u.pro'
        ]
        self.base_link = 'https://123-movies.mom'
